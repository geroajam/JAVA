...
import Servicios.ServiJuegos;
import Servicios.ServiJugador;
import Servicios.ServiRevolver;
...
public class MainRR {
    ...
    public static void main(String[] args) {
        ...
        //Instancio a la clase ServiJuegos, que da inicio al Juego
        ServiJuegos nuevoJuego = new ServiJuegos();
        //Instancio la clase ServiJugador para llena el listado de Jugadores 
        ServiJugador nuevosJugadores = new ServiJugador();
        //Instancio la clase ServiRevolver para cargar el Revolver
        ServiRevolver nuevoRevo = new ServiRevolver();
        
        
        //Con ServiJugador instanciado, llamo el método para cargar los jugadores
        ArrayList jugadores = nuevosJugadores.cargaJugadores();
        
        //y para llenar el Revolver
        Revolver revoInicio = nuevoRevo.llenarRevolver();
        
        
        //Con la lista de jugadores y el revólver cargados, lleno el Juego
        nuevoJuego.llenarJuego(jugadores, revoInicio);
        
        //y luego doy inicio a la ronda
        nuevoJuego.ronda();
